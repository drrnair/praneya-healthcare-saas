...
import { FamilyDashboard } from '@/lib/family-management/components/FamilyDashboard';

export default function FamilyManagementDemoPage() {
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Johnson Family Dashboard</h1>
              <p className="text-gray-600">4 members • Premium Plan • HIPAA Compliant</p>
            </div>
          </div>
  ...
  const renderMemberManagement = () => (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Visual Family Tree</CardTitle>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Granular access controls and privacy settings</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <div key={member.id} className="p-4 border border-gray-200 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Health Data: {member.privacyLevel}</p>
                    <p className="text-gray-600">Emergency Access: Enabled</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-900 mb-2">Restrictions</h4>
                    {member.role === 'child' && (
                      <div className="space-y-1">
                        <p className="text-gray-600">• Parental supervision required</p>
                        <p className="text-gray-600">• Screen time limits active</p>
                        <p className="text-gray-600">• Age-appropriate content only</p>
                      </div>
                    )}
                    {member.role === 'teen' && (
                      <div className="space-y-1">
                        <p className="text-gray-600">• School hours restrictions</p>
                        <p className="text-gray-600">• Limited provider communication</p>
                      </div>
                    )}
                    {(member.role === 'head' || member.role === 'parent') && (
                      <p className="text-gray-600">No restrictions</p>
                    )}
                  </div>
                </div>
              </div>
  ...
  const renderCollaborativeHealthPlanning = () => (
    <div className="space-y-6">
      <div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
              <h3 className="font-semibold text-red-800 mb-2">Break Glass Access</h3>
              <p className="text-sm text-red-700 mb-3">
                Emergency protocols allow authorized family members to access critical health information during medical emergencies.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p>• No emergency access events in the last 30 days</p>
                  <p>• Last audit: {new Date().toLocaleDateString()}</p>
                  <p>• All access attempts logged and monitored</p>
                </div>
              </div>
            </div>
          </div>
  ...
  const renderParentalControls = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-6">
            {familyMembers.filter(m => m.role === 'child' || m.role === 'teen').map((child) => (
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-gray-900">
                  Praneya Family Management Demo
                </h1>
        ...
        <div className="mb-8">
          <Tabs value={activeComponent} onValueChange={setActiveComponent}>
            ...
            <TabsContent value="collaboration">
              {renderCollaborativeHealthPlanning()}
            </TabsContent>
